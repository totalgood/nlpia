...
"""
Put all Ubuntu Dialog sessions into a single TSV.gz file (0.5 GB compressed)

Adapted from https://github.com/rkadlec/ubuntu-ranking-dataset-creator/blob/master/src/create_ubuntu_dataset.py
...
def ubuntu_dialog_corpus_v2(args):
